...
const Hero = () => {
  return (
    <section className='h-[90vh] shrink-0 flex flex-col  justify-center gap-6 relative'>
      <video
      ...
      <div className='section animate-fadeInUp'>
        <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl uppercase font-extrabold '>
